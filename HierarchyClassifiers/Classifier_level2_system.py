...
def second_level_classifier(X, XNoNPL, Z, Ypred, Xvalidate, XvalidateNoNPL, Yvalidate, Zvalidate, level):
    ...
    Inputs: X: all sentences to train on
            ...
            Zvalidate: 2nd level true labels of the validation data (labels to predict)
...
def train_classifier():
    ...
    XtrainSection = []; XtrainNoNPLSection = []; YtrainSection = []; ZtrainSection = []; TtrainSection = []; 
    XtestSection = []; XtestNoNPLSection = []; YtestSection = []; ZtestSection = []; TtestSection = []; YpredictionSection = []
    XvalSection = []; XvalNoNPLSection = []; YvalSection = []; ZvalSection = []; TvalSection = []; valPredSection = []
    ...
    second_level_classifier(XtrainSection+XtestSection, XtrainNoNPLSection+XtestNoNPLSection, ZtrainSection+ZtestSection, valPredSection, XvalSection, XvalNoNPLSection, YvalSection, ZvalSection, 'system')
