...
def second_level_classifier(X, XNoNPL, Z, Ypred, Xvalidate, XvalidateNoNPL, Yvalidate, Zvalidate, level):
    """
    ...
    Inputs: X: all sentences to train on
            ...
            Z: the 2nd level true labels of the sentences used for training
...
def train_classifier():
    ...
    second_level_classifier(XtrainSection+XtestSection, XtrainNoNPLSection+XtestNoNPLSection, ZtrainSection+ZtestSection, valPredSection, XvalSection, XvalNoNPLSection, YvalSection, ZvalSection, 'development process')
